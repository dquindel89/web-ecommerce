...
public class FileSystemStorageService implements StorageService{
    ...
    //private final static String STORAGE_LOCATION = "mediafile"; //Mejor esta parte lo referefimos desde el applicaction.properties
    ...
    public void init() {
        try {
            ...
            throw new StorageException("No se pudo crear el almacén de archivos: " +
                    storageLocation);
        }
    }
